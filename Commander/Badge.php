...
class Badge extends Alias
{
    ...
    static protected $name  = [
        ...
        550     => [
            'name'              => 'Made it to CONE SECTOR',
            'customText'        => 'Made it to CONE SECTOR' . PHP_EOL . PHP_EOL . PHP_EOL . ' (In one piece?)',
            'description'       => 'Visit CONE Sector by returning (FSD Jump) to the Gnosis in system Cone Sector FN-J b9-0.',
            'active'            => true,
            'hidden'            => true,
