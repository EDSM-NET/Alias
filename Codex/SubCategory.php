...
class SubCategory extends Alias
{
    ...
    static protected $in    = [
        ...
        21000   =>  [
            ...
            21130   => [21131, 21132, 21139, 21133, 21134, 21141,
                        21135, 21142, 21136, 21143, 21137],                                 // Lagrange Clouds
            21210   => [21211, 21212, 21213, 21214, 21215, 21216, 21217],                   // K-Type Anomalies
            21190   => [21191, 21194, 21195, 21196],                                        // L-Type Anomalies
            21150   => [21151, 21154],                                                      // P-Type Anomalies
            21170   => [21172, 21174, 21178, 21179],                                        // Q-Type Anomalies
        ],
        ...
        22000   =>  [                                                                   // Organic Structures
            ...
            22230   => [22231, 22232, 22233, 22234, 22235],                                 // Silicate Crystals
            ...
            22490   => [22491, 22492],                                                      // Stolon Pods

            22330   => [22331, 22332, 22333],                                               // Bell Molluscs
