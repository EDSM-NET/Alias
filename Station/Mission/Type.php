...
class Type extends Alias
{
    ...
    static protected $name  = [
       ...
       10505                                => 'Deliver %commodityCount% units of %commodity% in the name of democracy',
       10506                                => 'Help quell civil unrest by transporting %commodityCount% units of %commodity%',
       10507                                => 'Support the confederacy by delivering %commodityCount% units of %commodity%',
       10508                                => 'Deliver war supplies of %commodityCount% units of %commodity%',
       10509                                => 'Take %commodityCount% units of %commodity% in support of the current civil war',
       10510                                => 'Outbreak relief: %commodityCount% units of %commodity%',
       10511                                => 'Support famine relief by delivering %commodityCount% units of %commodity%',
       10512                                => 'Federal navy supply mission',
       10513                                => 'Imperial navy supply run',
       10514                                => 'Sensitive supply operation',
         ...
         610                                => 'Investors need %commodityCount% units of %commodity%',
         611                                => 'Supplier needs %commodityCount% units of %commodity%',
         612                                => 'Refugees needs %commodityCount% units of %commodity%',

       10601                                => 'Source and return %commodityCount% units of %commodity%',
       10602                                => 'Industry needs %commodityCount% units of %commodity%',
       10603                                => 'Supply %commodityCount% units of %commodity%',
       10604                                => 'Bring us %commodityCount% units of %commodity%',
       10605                                => 'Famine aid needed %commodityCount% units of %commodity%',
       10606                                => 'Outbreak aid needed %commodityCount% units of %commodity%',
       10607                                => 'We need %commodityCount% units of %commodity%',
       ...
       10609                                => 'The Federal Navy requires %commodityCount% units of %commodity%',
         ...
         711                                => '%commodity% Salvage to Aid Retreat',
        ...
        // Disable Missions
         ...
         858                                => 'Covert Action against %target% at %targetStationName%',
         ...
         906                                => 'Mining Investment for %commodityCount% units of %commodity%',
         907                                => 'Blast Out %commodityCount% units of %commodity%',
      ...
      101003                                => 'Massacre the %targetFaction% ships',
      101003                                => 'Massacre the %targetFaction% ships',
      101004                                => 'Imperial navy strike contract',
      101005                                => 'Federal navy strike contract',
      101006                                => 'Mete out justice on the %targetFaction% %targetType%',
      101007                                => 'Massacre the %targetFaction% %targetType%',
      ...
      101113                                => 'Remove %targetType%: %target%',
        ...
        1259                                => 'Covert Transportation Mission',
        ...
        1358                                => 'Financial Data Acquisition',
        1359                                => 'Economic Data Acquisition',
        1360                                => 'Offender Data Contract',
        1361                                => 'Tactical Data Acquisition',
        ...
        1904                                => 'Defend starport by defeating the %targetFaction% %targetType%',
    ...
    static protected $alias = [
        ...
        'mission_passengervip_celebrity_election'           => 237,
        ...
        'mission_deliverywing_democracy'                    => 10505,
        ...
        'mission_deliverywing_rankemp'                      => 10513,
        'mission_deliverywing_founder'                      => 10514,
        ...
        'mission_collect_investment'                        => 610,
        'mission_collect_civilliberty'                      => 611,
        'mission_collect_retreat'                           => 612,

        'mission_collectwing'                               => 10601,
        'mission_collectwing_industrial'                    => 10602,
        'mission_collectwing_civilwar'                      => 10603,
        'mission_collectwing_bust'                          => 10604,
        'mission_collectwing_famine'                        => 10605,
        'mission_collectwing_outbreak'                      => 10606,
        'mission_collectwing_civilunrest'                   => 10607,
        ...
        'mission_disable_blops_retreat'                     => 858,

        'mission_mining'                                    => 901,
        'mission_mining_boom'                               => 902,
        'mission_mining_expansion'                          => 903,
        'mission_mining_extraction'                         => 904,
        'mission_mining_bust'                               => 905,
        'mission_mining_investment'                         => 906,
        'mission_mining_civilliberty'                       => 907,
        ...
        'mission_massacrewing_conflict_civilwar'            => 101003,
        'mission_massacrewing_rankemp'                      => 101004,
        'mission_massacrewing_rankfed'                      => 101005,
        'mission_massacrewing_legal_prisoncolony'           => 101006,
        'mission_massacrewing_legal_bust'                   => 101007,
        ...
        'mission_assassinate_illegal_blops_civilliberty'    => 1162,
        ...
        'mission_smuggle_blops_civilliberty'                => 1259,
        ...
        'mission_hack_blops_investment'                     => 1358,
        'mission_hack_blops_boom'                           => 1359,
        'mission_hack_blops_prisoncol'                      => 1360,
        'mission_hack_blops_retreat'                        => 1361,
