...
class Available extends Alias
{
    ...
    static protected $name  = [
        ...
        22      => [
            // HARDPOINT - Cannon
            301     => [1, 2, 3,     ],         // Efficient
            302     => [1, 2, 3,     ],         // High capacity
            303     => [1, 2, 3,     ],         // Lightweight
            304     => [1, 2, 3,     ],         // Long range
            305     => [1, 2, 3,     ],         // Overcharged
        ...
        23      => [
            ...
            901     => [1, 2, 3,     ],         // Efficient
            902     => [1, 2, 3,     ],         // Focused
            903     => [1, 2, 3,     ],         // Lightweight
            904     => [1, 2, 3,     ],         // Long range
            905     => [1, 2, 3,     ],         // Overcharged
        ...
        24      => [
            ...
            801     => [1, 2, 3,     ],         // Efficient
            802     => [1, 2, 3,     ],         // Focused
            803     => [1, 2, 3,     ],         // Lightweight
            804     => [1, 2, 3,     ],         // Long range
            805     => [1, 2, 3,     ],         // Overcharged
