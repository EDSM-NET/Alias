...
class Description extends Alias
{
    ...
    static protected $name  = [
        ...
        // Beluga Liner
        128049345               => "The Beluga Class Liner is one of the most prestigious vessels to travel the space lanes. Only the Imperial Gutamaya liners rival these glorious vessels. If you want to travel in style, this is the vessel to do it in. A fighter hangar can be equipped to these ships.<br /><br />This ship requires a large sized landing pad to dock.",

        // Cobra MkIII
        128049279               => "The Cobra MkIII is a classic all-purpose ship found throughout human space. The model was first built in Lave Cowell & McGrath shipyard in Lave in 3100. Despite its age, it remains a popular ship for lone pilots who value its balance of carrying capacity and ability in combat.<br /><br />This ship requires at least a small sized landing pad to dock.",

        // Cobra MkIV
        128672262               => "The Cobra MkIV is Faulcon deLacy's development of the famous Cobra MkIII. It's a heavier and bulkier ship than the MkIII, but packs an extra punch and its better weaponry placement makes it a more effective combat vessel. It's tougher, to improve survivability, and allows better upgrading, but at the expense of some of its agility.<br /><br />This ship requires at least a small sized landing pad to dock.",
        ...
        // Diamondback Scout
        128671217               => "The Diamondback Scout is Lakon Spaceways' specialist combat explorer vessel. Unlike its bigger brother the Asp, the Diamondback Scout isn't suited as an all rounder vessel. It is popular with elite recon and pathfinder units with navies throughout human space. Its relatively low cost also makes it a popular choice with independent pilots who appreciate its combat and exploration potential.<br /><br />This ship requires at least a small sized landing pad to dock.",

        // Dolphin
        128049291               => "Saud Kruger build some of the finest luxury vessels travelling the space lanes. Their Dolphin class passenger vessel is able to transport a small number of people in extreme comfort.<br /><br />This ship requires at least a small sized landing pad to dock.",
        ...
        128672145               => "Many of Core Dynamics' customers desired more specific roles for their Dropships and the Assault Ship is a response to some of those demands. The Assault Ship is designed for a more combat intensive role than the original ship. It has improved manoeuvrability and weapon carrying capacity and placement. These additions come at the expense of smaller internals making it less versatile, but better in its specialised role.<br /><br />This ship requires at least a medium sized landing pad to dock.",
        ...
        // Federal Dropship
        128049321               => "The Federal Dropship is the Federation Navy's workhorse ship for tactical and special forces deployments. This is a well-armoured and well-armed ship capable of carrying large loads. Its versatile nature means that it is well-suited to tackling even the most hostile environment.<br /><br />This ship requires at least a medium sized landing pad to dock.",

        // Federal Gunship
        128672152               => "The Federal Gunship developed from the need for a more advanced support vessel in operations, utilising the standard Dropship frame. Its primary role is in fire support but it also supports higher rated modules making it more versatile. It can also be equipped with a fighter hangar.<br /><br />This ship requires at least a medium sized landing pad to dock.",
        ...
        // Hauler
        128049261               => "The Hauler is Zorgon Peterson's low-level entry in the freighter market and has been a big success. A large cargo capacity (for its size), cheap purchase price and low running costs have made these the most popular small cargo ships in human space.<br /><br />This ship requires at least a small sized landing pad to dock.",
