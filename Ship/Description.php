...
class Description extends Alias
{
    ...
    static protected $name  = [
        ...
        // Sidewinder
        128049249               => "Most pilots start their careers in the Sidewinder. It is a classic ship design that has been in use (in various configurations) since 2982. Its original design was as a light support ship and it lacked jump capability. Modern compact drives have enabled jump-capable versions to be created, making this a useful all-rounder. Some navies still use these ships as fighters and patrol craft.<br />
                                    <br />
                                    This ship requires at least a small sized landing pad to dock.",

        // Type-6 Transporter
        128049285               => "Lakon Spaceways is famous for building dependable, jump-capable transport vessels. The Type-6 Transporter is their smallest commercially available model. It has limited combat capability, but is capable of transporting decent-sized loads for its size class.<br />
                                    <br />
                                    This ship requires at least a medium sized landing pad to dock.",

        // Type-7 Transporter
        128049297               => "The Type-7 Transporter is Lakon Spaceways' mid range transport vessel. This is a new model, released in 3290. It is slow but moves a lot of tonnage for its size.<br />
                                    <br />
                                    This ship requires a large sized landing pad to dock.",

        // Type-9 Heavy
        128049333               => "The Type-9 Heavy is Lakon Spaceways' large freighter class. This ship is built to transport large cargos, a job it does very well, but it doesn't stand up well in a fight, although adding a fighter bay improves its combat capability considerably - in the right hands!<br />
                                    <br />
                                    This ship requires a large sized landing pad to dock.",
